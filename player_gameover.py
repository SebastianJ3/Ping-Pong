...
def player_game_over_screen(playerone_score, playertwo_score, screen):
    # Colors
    WHITE = (255, 255, 255)
    GOLD = (255, 215, 0)
     # Constants
    ...
    font = get_font()
    # Display winner text
    winner_text = font.render("PlayerOne Wins!" if playerone_score == 7 else "PlayerTwo Wins!", True, GOLD)
